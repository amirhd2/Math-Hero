...
export const TROPHY_STAGES: TrophyStageConfig[] = [
  ...
  },
  {
    ...
    description: 'نشانه استمرار در تمرین و تسلط بر ۲ مهارت ریاضی',
    icon: '🥉',
  ...
  },
  {
    ...
    description: 'تسلط بر مفاهیم پایه و حل دقیق مسائل در ۴ مرحله مهارت',
    icon: '🥈',
  ...
  },
  {
    ...
    description: 'تسلط چندجانبه بر ۶ مرحله مهارت در ۳ عملیات ریاضی',
    icon: '🥇',
  ...
  },
  {
    ...
    description: 'پیشتازی بی‌نظیر با ۱۰ مرحله مسلط‌شده در ۴ عملیات و مرورهای هوشمند هدفمند',
    icon: '💎',
    cupImage: 'assets/cups/ruby 1.webp',
    levelRequired: 17,
    badgesRequired: 25,
    masteredTiersRequired: 10,
    distinctOpsRequired: 4,
  },
  {
    stage: 6,
    stageNameFa: 'جام الماسین قهرمان قهرمانان',
    title: 'تاج زرین قهرمان ریاضی',
    description: 'بالاترین افتخار جهان ریاضی؛ تسلط عمیق بر ۱۴ مرحله در ۴ عملیات مختلف',
    icon: '👑',
    cupImage: 'assets/cups/Dimond 1.webp',
    levelRequired: 20,
    badgesRequired: 30,
    masteredTiersRequired: 14,
    distinctOpsRequired: 4,
  },
];
