...
export const SmartReviewHomeCard: React.FC<SmartReviewHomeCardProps> = ({
  ...
  if (!reviewState || !reviewState.hasEnoughData) {
    return (
      <div
        ...
        className="relative overflow-hidden rounded-3xl p-5 sm:p-6 bg-gradient-to-r from-violet-600 via-indigo-600 to-purple-700 text-white shadow-xl border border-indigo-400/30 flex flex-col sm:flex-row items-center justify-between gap-5"
      >
        <div className="flex items-center gap-4 text-center sm:text-right">
          ...
          <div className="space-y-1">
            <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-white/20 text-xs font-black">
              <span>⭐</span>
        ...
        <button
          ...
          className="w-full sm:w-auto px-6 py-3 bg-white text-indigo-950 hover:bg-indigo-50 font-black text-xs sm:text-sm rounded-2xl shadow-lg transition-transform active:scale-95 flex items-center justify-center gap-2 cursor-pointer shrink-0"
        >
  ...
  if (isHighMastery) {
    return (
      <div
        id="smart-review-home-card"
        className="relative overflow-hidden rounded-3xl p-5 sm:p-6 bg-gradient-to-r from-emerald-600 via-teal-600 to-indigo-700 text-white shadow-xl border border-emerald-400/30 flex flex-col sm:flex-row items-center justify-between gap-5"
      >
        <div className="flex items-center gap-4 text-center sm:text-right">
          <div className="w-14 h-14 rounded-2xl bg-white/15 backdrop-blur-md flex items-center justify-center text-3xl shadow-inner shrink-0">
            👑
        ...
        <button
          ...
          className="w-full sm:w-auto px-6 py-3.5 bg-amber-400 text-slate-950 hover:bg-amber-300 font-black text-xs sm:text-sm rounded-2xl shadow-lg transition-transform active:scale-95 flex items-center justify-center gap-2 cursor-pointer shrink-0"
        >
  ...
  return (
    <div
      id="smart-review-home-card"
      className="relative overflow-hidden rounded-3xl p-5 sm:p-7 bg-gradient-to-r from-indigo-900 via-indigo-800 to-purple-900 text-white shadow-xl border border-indigo-600/40 flex flex-col lg:flex-row items-center justify-between gap-6"
    >
      <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 text-center sm:text-right flex-1">
